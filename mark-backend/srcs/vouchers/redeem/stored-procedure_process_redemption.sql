...
BEGIN
    ...
    SELECT active_marks_balance INTO v_balance FROM students WHERE id = p_student_id FOR UPDATE;
    ...
    -- Debit
    UPDATE students SET active_marks_balance = active_marks_balance - p_cost WHERE id = p_student_id;
